    ...
    <body style="background-color: #0c070a">
        ...
        <div class="container titre">
            ...
            <h1>Bonjour <?php echo " "; echo $userinfo['Prenom']; ?></h1>
                    ...
                    <div style="margin-bottom:40px">
                        ...
                        <a href="editionprofil.php?id=<?php echo $_SESSION['id']?>"><input type="submit" name="editerprofil" value="Editer mon Profil"></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 offset-lg-1 column">
                    ...
                    <hr>
                    <b>Téléphone :</b><?php echo " 0"; echo $userinfo['Telephone']; ?>
                    
                   
                
                
                </div>
                <div class="col-md-6 col-lg-4 offset-lg-2 column">
...
<html>
  ...
  <h1 class="error-title">
    Oups, <br><br>Page introuvable
  </h1>
  <h2 class="error-subtitle">
      <a href=home.php>Retourner à la page home</a>
  </h2>
