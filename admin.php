...
if(isset($_GET['id']) AND $_GET['id'] > 0)
{
    ...
    $verifvendeur = $bdd->prepare('SELECT * FROM vendeur');
...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md">
            <a href="homeadministrateur.php?id=<?php echo $_SESSION['id']?>"><img src="EbayECE.jpg" height="65" width="auto"></a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item deroulant"><a class="nav-link" href="deconnexionAdministrateur.php">Se déconnecter</a>
                </li>
            </ul>
            </div>
        </nav>
                     ...
                     <div class="scroll-bar-wrap">
                        ...
                        ?>
                            ...
                            <?php 
                                ...
                                {
                            ?>
                                    <img src="vendeur/avatar/<?php echo $data['Profil'];?>" style="width:20%"><br>
                            ...
                            ?>
                                ...
                                <b>Pseudo :</b> <?php echo " "; echo $data['Pseudo']; ?><br>

                                <b>Nom : </b> <?php echo " "; echo $data['Nom']; ?><br>

                                <b>Prenom : </b> <?php echo " "; echo $data['Prenom']; ?><br>

                                <b>Email : </b> <?php echo $data['Email']; ?>
                        
                                <br>
                        
                                 <a href="supprimerVendeur.php?idvend=<?php echo $data['id']?>">Supprimer</a>
...
<html>
    ...
    <head>
        <title>Dynamisme avec JavaScript</title>
        <meta charset="utf-8">    
  ...
  <h1 class="error-title">
    Oups, <br><br>Il est interdit d'usurper l'identité d'un administrateur
  </h1>
  <h2 class="error-subtitle">
   La police est déjà en root
  </h2>
