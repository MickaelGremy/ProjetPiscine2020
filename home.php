...
<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md">
            <a href="home.php"><img src="EbayECE.jpg" height="65" width="auto"></a>
            ...
            <ul class="navbar-nav">
                <li class="nav-item deroulant"><a class="nav-link" href="#">Se connecter</a>
                    <ul class="sous">
                        <li><a href="connexionAcheteur.php">Je suis acheteur</a></li>
                        <li><a href="connexionVendeur.php">Je suis vendeur</a></li>
                        <li><a href="connexionAdministrateur.php">Connexion root</a></li>
                    </ul>
                </li>
            </ul>
            </div>
